...
def bounced(required_roles=[], required_scopes=[], allowed_types=["m2m","u2m"]):
    ...
    def real_decorator(function):
        ...
        if asyncio.iscoroutinefunction(function):
            async def bounced_function(root, info, *args, **kwargs):
                ...
                bouncer.bounce(required_roles=required_roles, required_scopes=required_scopes, allowed_types=allowed_types)
