...
class MatriseBase(models.Model):
    ...
    store = StoreField(
        verbose_name="store",
        storage=active_settings.getStorageClass(),
        upload_to="zarr",
        blank=True,
        null=True,
    ...
    dims = ArrayField(
        ...
        help_text="The arrays dimension",
        blank=True,
        null=True,
    )
    has_array = models.BooleanField(
        verbose_name="has_array",
        help_text="Does this Model have attached Data?",
        default=False,
    )
    name = models.CharField(
        max_length=1000, blank=True, null=True, help_text="Cleartext name"
    )
    unique = models.UUIDField(
        default=uuid.uuid4,
        editable=False,
        help_text="A unique identifier for this array",
    )
    fileversion = models.CharField(
        max_length=1000,
        help_text="The File Version of this Array",
        default=active_settings.FILE_VERSION,
    )
