...
import graphene
from grunnlag.filters import StageFilter
from grunnlag import types, models


class Stages(BalderQuery):
    """All Experiments
...
class StageDetail(BalderQuery):
    ...
    def resolve(self, info, id):
        x = models.Stage.objects.get(id=id)
        # assert (
