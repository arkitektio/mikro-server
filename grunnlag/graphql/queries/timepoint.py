...
import graphene
from grunnlag.filters import TimepointFilter
from grunnlag import types, models


class Timepoints(BalderQuery):
    """All Experiments
    ...
    class Meta:
        ...
        operation = "timepoints"
        paginate = True


class TimepointDetail(BalderQuery):
    ...
    def resolve(self, info, id):
        x = models.Timepoint.objects.get(id=id)
        # assert (
...
class MyTimepoints(BalderQuery):
