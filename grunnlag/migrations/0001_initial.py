    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(blank=True, help_text='The default color for the channel (might be ommited by the rendered)', max_length=1000, null=True)),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='channel_created_by', to=settings.AUTH_USER_MODEL)),
                ('created_through', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='channel_created_through', to='lok.lokclient')),
            ],
        ),
        migrations.CreateModel(
            name='Context',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pinned_by', models.ManyToManyField(blank=True, help_text='The users that have pinned the experiment', related_name='pinned_datasets', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('datasets', models.ManyToManyField(blank=True, null=True, related_name='experiments', to='grunnlag.Dataset')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_while', models.CharField(blank=True, max_length=1000, null=True)),
                ('affine_transformation', models.JSONField(blank=True, default=list, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('datasets', models.ManyToManyField(blank=True, null=True, related_name='omerofiles', to='grunnlag.Dataset')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shape', django.contrib.postgres.fields.ArrayField(base_field=models.IntegerField(), blank=True, help_text='The arrays shape format [c,t,z,y,x]', null=True, size=None)),
                ...
                ('datasets', models.ManyToManyField(blank=True, null=True, related_name='representations', to='grunnlag.Dataset')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('channel', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='views', to='grunnlag.channel')),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='view_created_by', to=settings.AUTH_USER_MODEL)),
                ('created_through', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='view_created_through', to='lok.lokclient')),
                ('instrument', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='views', to='grunnlag.instrument')),
                ('objective', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='views', to='grunnlag.objective')),
                ('omero', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='views', to='grunnlag.omero')),
                ('position', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='views', to='grunnlag.position')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_while', models.CharField(blank=True, max_length=1000, null=True)),
                ('data', models.FileField(null=True, storage=grunnlag.storage.PrivateMediaStorage(), upload_to='videos')),
                ('frontImage', models.ImageField(null=True, storage=grunnlag.storage.PrivateMediaStorage(), upload_to='video_fronts')),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='video_created_by', to=settings.AUTH_USER_MODEL)),
                ('created_through', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='video_created_through', to='lok.lokclient')),
                ('representations', models.ManyToManyField(help_text='The rendered bioimages', related_name='videos', to='grunnlag.Representation')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('representation', models.ForeignKey(help_text='The rendered biomage', on_delete=django.db.models.deletion.CASCADE, related_name='thumbnails', to='grunnlag.representation')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('datasets', models.ManyToManyField(blank=True, null=True, related_name='stages', to='grunnlag.Dataset')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('datasets', models.ManyToManyField(blank=True, null=True, related_name='samples', to='grunnlag.Dataset')),
        ...
        migrations.AddField(
            model_name='representation',
            name='table_origins',
            field=models.ManyToManyField(blank=True, null=True, related_name='derived_representations', related_query_name='derived_representations', to='bord.Table'),
        ),
        migrations.AddField(
            model_name='representation',
            name='tags',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_while', models.CharField(blank=True, max_length=1000, null=True)),
                ('name', models.CharField(help_text='The name of the relation', max_length=1000, unique=True)),
                ('description', models.CharField(blank=True, help_text='A verbose description of the relation', max_length=1000, null=True)),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='relation_created_by', to=settings.AUTH_USER_MODEL)),
                ('created_through', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='relation_created_through', to='lok.lokclient')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='position',
            name='stage',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='positions', to='grunnlag.stage'),
        ),
        migrations.AddField(
            model_name='position',
            name='tags',
        ...
        migrations.AddField(
            model_name='omero',
            name='positions',
            field=models.ManyToManyField(related_name='omeros', to='grunnlag.Position'),
        ),
        migrations.AddField(
            model_name='omero',
            name='representation',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(blank=True, help_text='The user that created/uploaded the file', null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('datasets', models.ManyToManyField(blank=True, null=True, related_name='models', to='grunnlag.Dataset')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('channel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='dimension_maps', to='grunnlag.channel')),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='dimensionmap_created_by', to=settings.AUTH_USER_MODEL)),
                ('created_through', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='dimensionmap_created_through', to='lok.lokclient')),
                ('omero', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='dimension_maps', to='grunnlag.omero')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='datalink_created_by', to=settings.AUTH_USER_MODEL)),
                ('created_through', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='datalink_created_through', to='lok.lokclient')),
                ('creator', models.ForeignKey(blank=True, help_text='The user that created the sample', null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('relation', models.ForeignKey(help_text='The relation between the two objects', on_delete=django.db.models.deletion.CASCADE, to='grunnlag.relation')),
        ...
        migrations.AddConstraint(
            model_name='channel',
            constraint=models.UniqueConstraint(fields=('name', 'emission_wavelength', 'excitation_wavelength'), name='Only one channel per name, emmission_wavelength and excitation_wavelength'),
        ),
    ]
