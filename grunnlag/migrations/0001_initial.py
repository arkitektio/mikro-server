...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('model_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='grunnlag.model')),
            ],
            options={
                'abstract': False,
            },
            bases=('grunnlag.model',),
        ),
        migrations.CreateModel(
            name='UserMeta',
            fields=[
        ...
        migrations.AddConstraint(
            model_name='representation',
            constraint=models.UniqueConstraint(fields=('name', 'sample'), name='Only one unique iamge per sample'),
        ),
        migrations.AddConstraint(
            model_name='position',
        ...
        migrations.AddField(
            model_name='imagetoimagemodel',
            name='tags',
            field=taggit.managers.TaggableManager(help_text='Tags for the model', through='taggit.TaggedItem', to='taggit.Tag', verbose_name='Tags'),
        ),
        migrations.AddField(
            model_name='imagetoimagemodel',
            name='training_data',
            field=models.ManyToManyField(related_name='training_data', to='grunnlag.Representation'),
        ),
        migrations.AddConstraint(
            model_name='feature',
