    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meta', models.JSONField(blank=True, null=True)),
                ('omero', models.JSONField(blank=True, default=dict, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('TIFF', 'Tiff'), ('JPEG', 'Jpeg'), ('MSR', 'MSR File'), ('CZI', 'Zeiss Microscopy File'), ('UNKNOWN', 'Unwknon File Format')], default='UNKNOWN', max_length=400)),
                ('file', models.FileField(blank=True, null=True, storage=grunnlag.storage.PrivateMediaStorage(), upload_to='files')),
