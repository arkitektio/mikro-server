    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('variety', models.CharField(choices=[('MASK', 'Mask'), ('VOXEL', 'Voxel'), ('UNKNOWN', 'Unknown')], default='UNKNOWN', help_text='The Representation can have varying types, consult your API', max_length=400)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(on_delete=models.SET(grunnlag.models.get_sentinel_user), to=settings.AUTH_USER_MODEL)),
                ('experiment', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='grunnlag.experiment')),
